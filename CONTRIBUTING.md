# Contributing to commitward

Thanks for your interest in commitward — a deterministic, fail-open human-sign-off gate for high-stakes commits. It is one component of the
...
git clone https://github.com/Barnett-Studios/commitward
cd commitward
cargo build
```
...
commitward is defined by its [`CONTRACT.md`](CONTRACT.md): the interface, the invariants, and the
...
[security advisory](https://github.com/Barnett-Studios/commitward/security/advisories/new) form so it can be
fixed before disclosure.

---

Questions that don't fit an issue? Open a
[discussion](https://github.com/Barnett-Studios/commitward/discussions). Thanks for contributing.
